      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/web-development" className="text-white hover:text-white transition duration-150">
                  Web Development
                </Link>
              </li>
              <li>
                <Link href="/services/app-development" className="text-white hover:text-white transition duration-150">
                  App Development
                </Link>
              </li>
              <li>
                <Link href="/services/digital-marketing" className="text-white hover:text-white transition duration-150">
                  Digital Marketing
                </Link>
              </li>
              <li>
                <Link href="/services/consulting" className="text-white hover:text-white transition duration-150">
                  IT Consulting
                </Link>
              </li>
            </ul>
